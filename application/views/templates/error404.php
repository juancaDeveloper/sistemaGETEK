...
<head>
	...
	<title>Error 404 | SIRPACEPV</title>
	...
	<link rel="stylesheet" href="<?php echo base_url("assets/fa5/css/all.min.css"); ?>">
					...
					<div class="row">
						<div class="col-md-12 my-5 text-center">
							<div class="text-danger">
								<i class="fas fa-unlink" aria-hidden="true" style="font-size:20em;"></i>
							</div>
							<h1 class="display-1">404</h1>
							<div class="display-4 mb-3">No encontrado</div>
							<div class="lead">No se encontró la página que solicitó.</div>
							<div class="lead mt-5"><a href="<?php echo base_url(); ?>"><i class="fas fa-home"></i> Regresar al inicio</a></div>
						</div>
					</div>
					<div class="row mb-4">
						<div class="col-md-12">
							<footer class="text-center">
								SIRPACEPV 1.0.0 &#169; <?php echo date('Y') ?>
							</footer>
						</div>
					</div>
				</main>
